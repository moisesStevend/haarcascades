...
##    frame = image.array
    ...
    #_, contours0, hierarchy = cv2.findContours(mask2,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)#,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE)
    _, contours0, hierarchy = cv2.findContours(mask2, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
